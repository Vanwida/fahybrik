...
1. **Selector de PESO rápido en el builder libre** (Alex, entrenando): el −/+ para la carga es lentísimo. Sustituir por una **rueda** (el patrón nativo que ya usamos en Registrar carrera) con pasos de 2,5 kg — y probar al construirlo si una regla horizontal arrastrable con ticks hápticos se siente mejor («algo guay»); decidir en el dispositivo, no en papel. Aplica a todos los campos de kg del builder.
