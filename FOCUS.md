...
Última actualización: **2026-09-25** (la muñeca se rehace: auditoría + modelo; propuestas en el doble en construcción)
...
En curso: kit `kit-reloj` + 6 propuestas `reloj-*` en el doble → firma de Alex → Swift (correr primero).
