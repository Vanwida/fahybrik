        ...
        return HStack(alignment: .center, spacing: 16) {
            VStack(alignment: .leading, spacing: 0) {
                Text(landscapeLegLine)
                    .font(.system(size: LandscapeTramo.identityPt, weight: .heavy, design: .default).italic())
                    .tracking(0.4)
                    .foregroundStyle(Theme.Color.accentText)
                    .lineLimit(1)
                    .minimumScaleFactor(0.7)
                Text(legTitle)
                    .font(.system(size: LandscapeTramo.titlePt, weight: .semibold))
                ...
                Spacer(minLength: 4)
                Text(sujeto.cifra)
                    .font(.system(size: LandscapeTramo.subjectPt, weight: .heavy, design: .monospaced).monospacedDigit())
                    .foregroundStyle(Theme.Color.foreground)
