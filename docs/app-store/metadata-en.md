---
title: App Store Connect — English (en-US) metadata
locale: en-US
status: draft
last_updated: 2026-05-08
---

# FAHYBRID — App Store metadata (English, secondary locale)

Add this locale via App Store Connect → My Apps → FAHYBRID → App Information → Add language → English (U.S.).
...
Designed with a single coach (Pablo Pérez Gómez, Fabrik Training Club Barcelona) and his competing athletes. Density over simplicity. Raw metrics. No gamification fluff. If you compete in HYROX or train seriously to, this is for you.
```

(≈ 220 words / 1450 chars.)
...
- Performance: HRV, sleep, weekly load, HYROX splits, PRs

Connectivity: Apple Health, Garmin Connect, Concept2 PM5 Bluetooth.

Report any issue to your coach via in-app chat.
```
