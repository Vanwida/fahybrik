...
export const SYSTEM_PROMPT = [
  ...
  '- Inclinación de cinta / pendiente en PORCENTAJE (6% = 6). Solo si aparece; si no, null.',
  '',
  ...
  '"calories":n,"avg_spm":n,"avg_incline_pct":n,"avg_power_w":n,"training_load":n,',
  '"splits":[{"index":n,"item_uid":s,"time_s":n,"distance_m":n,"pace_s":n,',
  '"spm":n,"incline_pct":n,"avg_hr":n,"power_w":n,"calories":n}],',
