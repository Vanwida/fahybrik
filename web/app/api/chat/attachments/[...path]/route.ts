...
// Las cabeceras del proxy viven en `lib/attachments/proxy-headers`: son las
// mismas que usa el proxy de la nota de voz de un comunicado, y con una copia en
// cada ruta el día que se arregle una cabecera aquí la otra se queda con el
// fallo. Se reexportan para no mover de sitio los tests que ya las prueban.
export { buildDownstreamHeaders, buildUpstreamHeaders };
