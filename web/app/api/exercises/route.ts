 ...
 * modality (+ optional `video_url`: a YouTube link OR the HLS manifest of a video the
 * coach uploaded via POST /api/coach/exercises/video/subida — one column, two forms,
 * see lib/exercises/video-source.ts). The coach DECLARES the modality — not derived
