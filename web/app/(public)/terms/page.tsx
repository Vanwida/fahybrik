...
export const metadata: Metadata = {
  title: 'Términos de servicio — FAHYBRIK',
  description:
    'Términos y condiciones de uso de FAHYBRIK, plataforma de coaching élite HYROX operada por Vanwida.',
...
export default function TermsPage() {
  return (
    <article>
      ...
      <P>
        Bienvenido a FAHYBRIK. Al usar la app, aceptas los términos descritos a
      ...
      <P>
        <Term>FAHYBRIK</Term> es una plataforma de <Term>coaching élite HYROX e
        híbrido</Term> operada por <Term>Vanwida</Term>, sociedad con sede en España. El
      ...
      <P>
        FAHYBRIK no es una app de entrenamiento generalista, ni un marketplace de
      ...
      <P>Al usar FAHYBRIK, te comprometes a:</P>
      <UL>
        <li>
      ...
      <P>
        <Term>FAHYBRIK no es un servicio médico ni sustituye al consejo de un profesional
      ...
      <UL>
        ...
        <li>
          Los datos biométricos provenientes de wearables (Garmin, Apple Watch, Concept2)
      ...
      <P>
        Vanwida no se hace responsable de lesiones, accidentes o daños derivados del
      ...
      <P>
        ...
        FAHYBRIK — incluida la metodología ATR de Pablo, las plantillas de sesión, la
        biblioteca de ejercicios y el material editorial — son propiedad intelectual de
        Vanwida y/o de Pablo, según corresponda.
      </P>
      <UL>
        <li>
        ...
        <li>
          Las marcas <Term>FAHYBRIK</Term>, <Term>Vanwida</Term> y{' '}
          <Term>Fabrik Training Club</Term>, junto con sus logotipos asociados, son marcas
      ...
      <UL>
        <li>
          FAHYBRIK funciona bajo modelo de <Term>suscripción</Term>. La estructura y
      ...
      <UL>
        ...
        <li>
          Vanwida puede <Term>suspender o terminar</Term> tu cuenta si:
      ...
      <P>
        El servicio se ofrece <Term>"tal cual"</Term> y <Term>"según disponibilidad"</Term>.
      ...
      <P>
        ...
        agregada de Vanwida frente a ti, por cualquier reclamación derivada del uso del
      ...
      <UL>
        <li>A daños causados por dolo o negligencia grave de Vanwida.</li>
        <li>
