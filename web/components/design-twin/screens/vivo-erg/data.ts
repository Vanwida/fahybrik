// El ergo por series — los datos. Todo se DERIVA de una curva fija por máquina,
// así el monitor del doble no puede contradecirse consigo mismo ni cambiar entre
// reproducciones (mismo criterio que `benchmark-erg/data.ts`).
//
