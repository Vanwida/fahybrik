...
export const meta: TwinMeta = {
  ...
  fuentes: [],
  enApp:
    'Hoy todo esto viaja por el chat como texto libre y el atleta no tiene bandeja: un push perdido es un mensaje perdido.',
  dispositivo: 'iphone',
  soportaHorizontal: false,
  // Sin `composicion` a propósito: la ficha del §6 enciende el conmutador
  // «cómo está hoy / propuesta», y aquí NO hay un hoy que enseñar — esta
  // superficie no existe en la app. Declararla pintaría dos veces la misma
  // pantalla bajo dos rótulos distintos, que es precisamente la clase de teatro
  // que el sello de estado del doble existe para impedir. El arquetipo es Lista
  // y la estrategia `llena`, y eso se cumple; lo que no hay es un antes.
};
