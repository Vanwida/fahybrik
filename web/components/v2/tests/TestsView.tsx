...
// (which week(s)/day). "Restaurar los 4 de FABRIK" reseeds the defaults.
//
  ...
  return (
    <div className="mt-2 flex flex-wrap items-center gap-3 rounded-[var(--v2-r-m)] border border-dashed border-[color:var(--v2-border-strong)] bg-[color:var(--v2-surface)] px-4 py-3 text-xs text-[color:var(--v2-muted)]">
      ...
      <span className="flex-1">
        En la primera semana del atleta el sistema <b className="text-[color:var(--v2-fg)]">programa estos tests</b> y con sus
        resultados <b className="text-[color:var(--v2-fg)]">calibra zonas y 1RM</b>. Ordénalos por el día en que quieres que caigan.
      </span>
      <button
        type="button"
        onClick={onRestore}
      ...
      >
        <MIcon name="restart_alt" size={14} /> {restoring ? 'Restaurando…' : 'Restaurar los 4 de FABRIK'}
      </button>
    </div>
  );
}
  ...
  return (
    <div className="mt-1 flex flex-col items-center rounded-[var(--v2-r-l)] border border-dashed border-[color:var(--v2-border)] px-5 py-11 text-center">
      ...
      <p className="mx-auto mt-1.5 max-w-[420px] text-[13px] leading-relaxed text-[color:var(--v2-muted)]">
        ...
        quedan en la estimación del onboarding. Empieza con los 4 de FABRIK o crea el tuyo.
      </p>
      <div className="mt-4 flex flex-wrap justify-center gap-2.5">
        ...
        >
          <MIcon name="restart_alt" size={16} /> {restoring ? 'Restaurando…' : 'Restaurar los 4 de FABRIK'}
        </button>
        <button
          type="button"
          onClick={onCreate}
