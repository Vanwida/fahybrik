...
export function BulkBar({
  ...
  return (
    <div
      ...
      className={cn(
        'fixed left-1/2 z-[80] flex max-w-[calc(100vw-24px)] -translate-x-1/2 items-center gap-1 overflow-x-auto',
    ...
    >
      <span className="flex shrink-0 items-center gap-2 pr-2 pl-2 t-body font-semibold text-v2-fg t-tnum">
      ...
      <button
        ...
        className="flex h-7 shrink-0 items-center gap-1.5 rounded-ctl px-2 text-v2-muted outline-none hover:bg-v2-hover hover:text-v2-fg focus-visible:shadow-[0_0_0_2px_var(--v2-accent)]"
      >
