...
export function DayEditor({
  ...
  const handleSave = () => {
    // TODO(endpoint): PUT the day's sessions[] back into the week's slots_json via
    // the program-weeks update path (the WeekDayPart shape is preserved 1:1).
    setSaved(true);
    ...
    <div className="mx-auto flex w-full max-w-[1480px] flex-col gap-5">
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div className="flex min-w-0 flex-col gap-2">
          <Link
            href={`/v2/microciclos/${model.month_id}`}
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <button
            type="button"
            onClick={handleSave}
            className="v2-focus inline-flex h-10 items-center gap-1.5 rounded-[var(--v2-r-s)] bg-[color:var(--v2-accent)] px-4 text-sm font-bold text-[color:var(--v2-accent-fg)] transition-colors hover:bg-[color:var(--v2-accent-press)]"
          >
