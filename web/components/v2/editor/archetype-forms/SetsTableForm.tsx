...
export function SetsTableForm({
   ...
   * reutiliza este formulario entero con `scheme="superset"`: sin esto, cambiar el
   * objetivo de carga devolvía el bloque a series rectas y se perdía la rotación.
   */
