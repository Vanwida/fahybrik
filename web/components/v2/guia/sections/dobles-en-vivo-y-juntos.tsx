// GUÍA · Dobles en pareja: en vivo y juntos — La capa EN DIRECTO
...
export default function Section({ meta }: { meta: GuiaSection }) {
  return (
    ...
    >
      ...
      <h3>En vivo: cuando uno entrena, el otro lo ve</h3>
      <p>
      ...
      <h3>El relevo, dirigido estación a estación</h3>
      <p>
