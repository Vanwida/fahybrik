// GUÍA · Zonas de pulso personales — Del lado del
...
import { EJEMPLO_UMBRAL, ZoneRow, PulseRow, AnchorRung } from './piezas/zonas-de-pulso';
    ...
    <DocSection
      ...
      lead={
        <>
          ...
          <b>medido</b>. Por eso una zona es una <b>fracción de su FC de umbral</b> (lo que un test
          mide y contra lo que tú prescribes), no un porcentaje de una FC máxima que casi nadie ha
          medido. Y si no hay nada que la ancle, <b>no hay zonas</b>: la app lo dice, no se las
          inventa.
        </>
      }
    >
      <QCWTriad
        ...
        porque={
          <>
            ...
            porcentaje de un máximo estimado por la edad son <b>dos suposiciones apiladas</b>.
          </>
        }
      />
      ...
      <h3>Las cinco bandas, en fracciones del umbral</h3>
      <p>
      ...
      <h3>De dónde sale el umbral: tres peldaños</h3>
      <p>
      ...
      <h3>Lo que ve tu atleta: tres estados, sin trampa</h3>
      <p>
      ...
      <h3>Lo estimado viaja pegado al número</h3>
      <p>
      ...
      <h3>En tu panel</h3>
      <p>
        En su ficha, <b>Rendimiento › Zonas y tests</b> enseña sus zonas y de qué test salen, y{' '}
        <b>Running › Tiempo en zonas</b> reparte su tiempo contra <b>sus</b> bandas, no contra un
        número igual para todos. Si sus zonas salen de una estimación, lo avisa («un test lo
        clava»); si no tiene ancla, no enseña ningún reparto y enlaza a programarle el test de
        umbral.
      </p>
      ...
      <DocNote variant="cue" title="Lo único que puedes pedirle">
        <p>
          ...
          umbral</b>. Prográmaselo como cualquier otro test (ver <b>Tests</b>). Mientras
