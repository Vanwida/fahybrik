// GUÍA · Prescribir una carrera — área «Programar». Cómo prescribes un rodaje o unas
  ...
  return (
    ...
    >
      <QCWTriad
        que={
          <>
            El formulario de un bloque de <b>carrera</b>: montas el rodaje tramo a tramo. Cada tramo es{' '}
        ...
        porque={
          <>
            ...
            es lo que luego lees como prescrito contra hecho.
          </>
        }
      />
      ...
      <h3>Dónde se abre</h3>
      <p>
        En cualquier bloque de carrera: en el <b>Detalle</b> de una celda de un programa, en un
        entreno o bloque de la <b>biblioteca</b> o en el entreno de un atleta desde su ficha. Si solo
        necesitas algo simple, la línea rápida vale (<code>8x400m r1&apos; z4</code>); este formulario
        es para cuando la carrera tiene fases y series dentro de series.
      </p>

      <h3>Tres fases, en orden</h3>
      <p>
      ...
      <h3>Cada tramo: qué se mide y contra qué</h3>
      <p>
      ...
      <DocNote variant="cue" title="Empieza por un arquetipo, no de cero">
        <p>
          ...
          totalmente editable. No son moldes cerrados: siembran la misma estructura para que
