// GUÍA · Al acabar el entreno — Qué pasa cuando el atleta cierra
...
//      badge "PR · 5 km", tiempo grande, RITMO/ZONA/RPE, el dominio de la app — solo muestra lo real)
...
//     (buzón "Enviar sugerencia o error" → equipo del producto; NO al
...
export default function Section({ meta }: { meta: GuiaSection }) {
  return (
    ...
    >
      ...
      <h3>«Cómo ha ido»: te llega a ti</h3>
      <p>
      ...
      <h3>Dónde lo ves</h3>
      <p>
        Ese feedback te espera en dos sitios que ya usas: en la línea de Hoy{' '}
        <b>«N entrenos registrados hoy · ver»</b> (lo que ha entrenado tu gente) y en el entreno, al
        abrirlo en el calendario de su ficha. Y hay una diferencia clave: una <b>molestia</b> no se
        queda como un dato pasivo: sube a <b>Hoy</b> como señal a <b>vigilar</b>, con la zona y la nota,
        para que la veas aunque no abras la ficha.
      </p>
