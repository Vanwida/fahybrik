// GUÍA · Pausas y bajas — La vida real interrumpe (un
  ...
  return (
    ...
    >
      ...
      <QCWTriad
        ...
        como={
          <>
            En su ficha, el <b>···</b> de arriba: <b>Pausar</b> (motivo + fecha de vuelta opcional) o{' '}
            <b>Dar de baja</b>. Para varios a la vez, <b>Pausar</b> en la barra de Atletas.
      ...
      <h3>La pausa: congela el plan y no penaliza</h3>
      <p>
        La pausa la inicias tú desde la ficha, o la <b>pide el atleta desde su app</b> y te llega como
        una solicitud, arriba en su ficha, que <b>confirmas o rechazas</b>: el sistema nunca pausa a nadie solo. Al
      ...
      <h3>La baja: cierra conservando todo</h3>
      <p>
