// GUÍA · Pagos: cobro por Stripe — El precio nace en el
...
export default function Section({ meta }: { meta: GuiaSection }) {
  return (
    ...
    >
      ...
      <h3>El precio nace en el alta</h3>
      <p>
      ...
      <h3>El pago activa el acceso</h3>
      <p>
      ...
      <h3>Los estados, con los vencidos primero</h3>
      <p>
