// GUÍA · Leads: tu embudo de entrada — Cada visita que deja su
...
import { DocSection, QCWTriad, DocNote, MovilBand, PhoneMockup, PanelFigure, Badge } from '../doc';
  ...
  return (
    <DocSection
      ...
      lead={
        <>
          ...
          mitad del formulario. La sección <b>Leads</b> es tu embudo: la lista de todas esas
    ...
    >
      <QCWTriad
        ...
        como={
          <>
            En <b>Negocio › Leads</b>, filtrada por <b>Abiertos</b> o por estado, con el siguiente paso
            en cada fila y su email y teléfono a un clic. Al abrir uno, su ficha sale a la derecha con
            todo lo que contó en el formulario. Mueves su estado a mano{' '}
      ...
      <h3>Cada email que entra es un lead tuyo</h3>
      <p>
        El lead rellena tu formulario en la web. En cuanto deja su email{' '}
      ...
      <h3>El estado solo avanza, nunca retrocede</h3>
      <p>
      ...
      <PanelFigure caption={<>El camino de un lead. <b>Descartado</b> sale del camino (y se puede reabrir).</>}>
        <div className="flex flex-wrap items-center gap-2 t-meta text-v2-faint">
          <Badge tone="neutral" label="Sin terminar" />
          <span aria-hidden>→</span>
          <Badge tone="info" label="Nuevo" />
          <span aria-hidden>→</span>
          <Badge tone="info" label="Contactado" />
          <span aria-hidden>→</span>
          <Badge tone="ok" label="Cita agendada" />
          <span aria-hidden>→</span>
          <Badge tone="ok" label="Convertido" />
        </div>
      </PanelFigure>
      ...
      <MovilBand
        ...
        subtitle={
          <>
            ...
            un formulario de toques. El momento clave es cuando deja su email: ahí, y no antes, se
