// GUÍA · Correr en cinta — Breve, del lado del atleta, para que
...
export default function Section({ meta }: { meta: GuiaSection }) {
  return (
    ...
    >
      ...
      <h3>La conectas antes de empezar, y eliges tu máquina</h3>
      <p>
      ...
      <p>
        ...
        entreno, con su batería visible al lado del nombre.
      </p>
      ...
      <h3>Se conecta a la cinta, no la sustituye</h3>
      <p>
      ...
      <h3>Los metros del cinturón quedan registrados</h3>
      <p>
      ...
      <h3>Y en la muñeca, lo mismo que en el móvil</h3>
      <p>
