// GUÍA · Entrenar en dobles — Dos atletas, una pareja: comparten
  ...
  return (
    ...
    >
      <QCWTriad
        ...
        como={
          <>
            Los emparejas en <b>Atletas › ··· › Parejas de dobles</b> (o se invitan entre ellos). Ahí
            les asignas el plan a los dos y editas el <b>reparto</b> de estaciones. En su móvil,
      ...
      <h3>En el panel: Parejas de dobles</h3>
      <p>
        En <b>Atletas</b>, el <b>···</b> de arriba abre <b>Parejas de dobles</b>: las parejas activas,
        cada una con si ya comparten plan. <b>Vincular pareja</b> une a dos atletas sin pareja;{' '}
        <b>Asignar plan</b> (o <b>Reasignar plan</b>) les da el mismo plan a los dos, cada uno a su
        intensidad; <b>Reparto</b> abre el reparto de la simulación; y en su <b>···</b>,{' '}
        <b>Deshacer pareja</b>. Desde ahí mismo, <b>Consejos de dobles</b>.
      </p>

      <h3>Una pareja de verdad: emparejamiento por invitación</h3>
      <p>
      ...
      <h3>El reparto de estaciones es de la pareja</h3>
      <p>
      ...
      <h3>El relevo no es tu volumen</h3>
      <p>
      ...
      <DocNote variant="cue" title="Un cobro por pareja">
        <p>
          Dobles es <b>una sola suscripción</b> que cubre las dos cuentas : paga uno en el
      ...
      <h3>La carrera de dobles: predicho contra meta, tramo a tramo</h3>
      <p>
      ...
      <h3>Los consejos de dobles son tuyos</h3>
      <p>
        Debajo del board (y de la simulación conjunta) el atleta lee unos <b>consejos</b> que son
        tuyos: los editas en <b>Atletas › ··· › Parejas de dobles › Consejos de dobles</b>, en dos bloques
        separados (uno para el{' '}
      ...
      <DocNote variant="cue" title="Sin tiempo meta, no hay board">
        <p>
          El board solo aparece cuando la carrera objetivo de dobles tiene <b>tiempo meta</b> (lo pone
          el atleta en su app) y la pareja está <b>activa</b>. Sin meta, no hay contra qué medir.
        </p>
      </DocNote>
