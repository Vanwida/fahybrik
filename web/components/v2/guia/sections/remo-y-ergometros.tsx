// GUÍA · Remo y ergómetros a fondo — Del lado del
...
export default function Section({ meta }: { meta: GuiaSection }) {
  return (
    ...
    >
      <QCWTriad
        ...
        como={
          <>
            ...
            su <b>tabla de intervalos</b>. Tú abres el entreno en su ficha y ves la misma
      ...
      <h3>Enlaza el PM5, y elige el tuyo</h3>
      <p>
      ...
      <h3>La misma tabla, en tu panel</h3>
      <p>
        No hay «versión del atleta» y «versión tuya»: es <b>el mismo registro</b>. Al abrir el entreno
        en la ficha de tu atleta ves su tabla de intervalos con una columna más de <b>vatios</b>, el{' '}
      ...
      <h3>Potencia y calorías, con tendencia</h3>
      <p>
