// GUÍA · Cupo y lista de espera — El grupo tiene un tope de
...
export default function Section({ meta }: { meta: GuiaSection }) {
  return (
    ...
    >
      ...
      <QCWTriad
        ...
        como={
          <>
            ...
            el formulario termina en lista de espera; al liberarse una plaza, avisa al primero. Y
      ...
      <h3>El cupo y el borde exacto</h3>
      <p>
      ...
      <h3>La lista de espera es una cola por orden de llegada</h3>
      <p>
      ...
      <h3>Liberar una plaza: automático + tu override</h3>
      <p>
      ...
      <MovilBand
        ...
        subtitle={
          <>
            Si el grupo está completo al terminar el formulario, el lead <b>no ve la reserva de cita</b>
      ...
      >
        <PhoneMockup
          caption={
            <>
              <b>Lista de espera.</b> El formulario termina aquí en vez de ofrecer hueco. Le decimos su{' '}
