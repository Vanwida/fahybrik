// GUÍA · Correr al aire libre, en vivo — Del lado del atleta,
...
export default function Section({ meta }: { meta: GuiaSection }) {
  return (
    ...
    >
      ...
      <h3>El rodaje con el mapa, en vivo</h3>
      <p>
      ...
      <h3>Se pausa en el semáforo y cierra los tramos solo</h3>
      <p>
      ...
      <h3>En la pantalla bloqueada y la Isla Dinámica</h3>
      <p>
      ...
      <h3>La app le habla: avisos de voz</h3>
      <p>
      ...
      <h3>Y en la muñeca, sin móvil</h3>
      <p>
