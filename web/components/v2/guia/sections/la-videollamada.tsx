// GUÍA · La videollamada con tu lead — El lead reserva un hueco de
  ...
  return (
    ...
    >
      ...
      <QCWTriad
        ...
        como={
          <>
            Pones tus horarios una vez en <b>Ajustes › Agenda y cupo</b> (huecos de <b>30 min</b>). El lead abre su
      ...
      <h3>Tú pones los huecos, el lead elige</h3>
      <p>
        ...
        próximos 14 días. El lead elige la modalidad y solo ve los huecos de
      ...
      <h3>Tras la llamada: el parte 1:1</h3>
      <p>
      ...
      <DocNote variant="cue" title="Videollamada o presencial">
        <p>
          ...
          Meet, el email y el <b>.ics</b> llevan la <b>dirección de tu box</b> (la de Tu club) con
      ...
      <MovilBand
        ...
        subtitle={
          <>
            El lead reserva desde la <b>web</b>, con el enlace que recibió al terminar el formulario.
