// GUÍA · Objetivo y predicción — El "camino al objetivo":
...
// Athlete-facing (el gap board vive en su móvil); el atleta fija la meta en su
...
export default function Section({ meta }: { meta: GuiaSection }) {
  return (
    <DocSection
      ...
      lead={
        <>
          El <b>camino al objetivo</b>: tu atleta pone un tiempo meta a su carrera objetivo y la app lo
    ...
    >
      <QCWTriad
        ...
        como={
          <>
            Tu atleta pone el <b>tiempo meta</b> en su carrera objetivo, desde su app (los objetivos
            son suyos; tú los ves). El presupuesto sale de una{' '}
      ...
      <h3>El presupuesto siempre cierra</h3>
      <p>
      ...
      <h3>La predicción, con su origen a la vista</h3>
      <p>
      ...
      <h3>Predicho vs real: la predicción se congela</h3>
      <p>
      ...
      <p style={{ marginTop: '18px' }}>
        ...
        tiempo que le falta, y tú sabes qué tramo priorizar al programar. El sistema{' '}
