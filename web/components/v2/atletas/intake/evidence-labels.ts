...
// for the V2 intake evidence rail. Pure data + pure functions (no React) — kept
// self-contained in the V2 tree (NOT imported from the V1 intake module, which
// is being deleted). Copied faithfully from the V1 evidence-labels so the rail
// surfaces every onboarding datum with the same human copy.
