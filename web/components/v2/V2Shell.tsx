...
// utility bar holding the tenant brand (mobile only; the sidebar carries it on
// desktop) and the account menu. Pages render inside <main>. The font variables
// (Bricolage + Figtree) arrive from the server layout via `font_vars`.
...
export function V2Shell({
  ...
  return (
    <div className={cn('v2-root', font_vars)}>
